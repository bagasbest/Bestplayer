        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text(
                'Anda berhasil terdaftar pada Sistem Bestplayer\n\nSilahkan Login dengan akun anda',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 15,
                ),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'Anda gagal terdaftar dalam Sistem Bestplayer, silahkan periksa data yang anda inputkan dan periksa koneksi internet, coba lagi kemudian',
            style: TextStyle(
              color: Colors.black,
            ),
          ),
